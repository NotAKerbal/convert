...
import canvasToBlobLiteHandler from "./canvasToBlobLite.ts";
...
import { fromJsonHandler, toJsonHandler } from "./jsonLite.ts";
...
try { handlers.push(new canvasToBlobLiteHandler()) } catch (_) { };
